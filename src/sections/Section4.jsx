...
const Section4 = () => {
  return (
    <div id='section4' className='bg-black px-[10px] md:px-[150px] lg:px-[250px] pt-8 flex flex-col justify-center items-center w-[100%]'>
      ...
      <div className='mt-[60px] max-w-[580px] px-[10px]'>
